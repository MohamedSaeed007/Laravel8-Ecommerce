                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="javascript:void(0);" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ml-1">{{ __('Admin Login') }}</h2>
                                </a>

                                <h4 class="card-title mb-1">Welcome to {{ __('Admin Login') }} 👋</h4>
                                <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>

                                <form class="auth-login-form mt-2" action="{{ route('admin.login.submit') }}"
                                    method="POST">
                                    @csrf
                                ...
                                <div class="auth-footer-btn d-flex justify-content-center" style="display: none !important">
