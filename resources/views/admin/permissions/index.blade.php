                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="">{{ __('site.permissions') }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <section id="basic-datatable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form id="deleteForm{{ $permission->id }}"
                                                action="{{ route('admin.permissions.destroy', $permission) }}" method="POST">
                                                @csrf
                                                @method('delete')
                                            </form>
                                        </td>
            ...
            <div class="modal modal-slide-in fade" id="modal">
                <div class="modal-dialog sidebar-sm">
                    <form class="add-new-record modal-content pt-0" action="{{ route('admin.permissions.store') }}"
                        method="POST">
                        @csrf
                        ...
                        <div class="modal-body flex-grow-1">
                            ...
                            <div class="form-group">
                                <label class="form-label"
                                    for="basic-icon-default-fullname">{{ __('site.permission name') }}</label>
