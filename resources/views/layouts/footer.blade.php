        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="payments">
                        <ul>
                            <li><img src="{{ asset('frontend') }}/assets/img/preview/payments/visa.jpg" alt=""/></li>
                            <li><img src="{{ asset('frontend') }}/assets/img/preview/payments/mastercard.jpg" alt=""/></li>
                            <li><img src="{{ asset('frontend') }}/assets/img/preview/payments/paypal.jpg" alt=""/></li>
                            <li><img src="{{ asset('frontend') }}/assets/img/preview/payments/american-express.jpg" alt=""/></li>
                            <li><img src="{{ asset('frontend') }}/assets/img/preview/payments/visa-electron.jpg" alt=""/></li>
                            <li><img src="{{ asset('frontend') }}/assets/img/preview/payments/maestro.jpg" alt=""/></li>
                        </ul>
                    </div>
                </div>
